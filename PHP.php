...
print_r($a);      // Arra([1] => bool [11] => 1.33 [] => null [0] => 08 [12] => smth [04] => 4 [13] => smth2)
...
Так как все ключи в вышеприведенном примере преобразуются к 1, значение будет перезаписано на каждый новый элемент и останется только последнее присвоенное значение "d". 						 
	...
	#Array([foo] => bar [bar] => foo [100] => -100 [-100] => 100 [101] => smth)
	/*
	array(5) {
	  ["foo"]=>string(3) "bar"
	  ["bar"]=>string(3) "foo"
...
$a == $b			Равно						TRUE в случае, если $a и $b содержат одни и те же пары ключ/значение. // TODO
...
<?
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Сессии - позволяют хранить данные о пользователе на сервере.Специальный файл который хранится во временной папке на сервере.В этом файле могут быть записаны данные связанные с
...
Что происходит, когда мы присваиваем переменной $а некоторое значениу?
